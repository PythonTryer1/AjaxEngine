...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <input style="" id="Button2" type="button" value="Html Button 调用页面方法" onclick="return Button2_onclick()" /><input id="Button3" type="button" value="Html Button 调用AjaxHandler方法" onclick="    return Button3_onclick()" />
        </div>
    ...
    <script src="https://raw.githubusercontent.com/Houfeng/ems/master/build/ems.js"></script>
    <script>
    ...
    function Button3_onclick() {
        ems.require(['Handler1.ashx?client-script=core,agent'], function (Handler1) {
